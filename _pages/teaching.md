...
<div class="mentoring-list">
  ...
  <article class="mentoring-item">
    ...
    <h3>Arjun Mittha</h3><p>Combinatorial optimization</p>
  </article>
  <article class="mentoring-item">
    <p class="item-meta">Spring 2025</p>
    <h3>Darsh Verma</h3><p>The art of combinatorial proof</p>
  </article>
  <article class="mentoring-item">
    <p class="item-meta">Winter–Spring 2024</p>
    <h3>Thomas Slavonia</h3><p>Representation theory of the symmetric group; Schubert polynomials and pipe dreams</p>
  </article>
  <article class="mentoring-item">
    <p class="item-meta">Winter 2024</p>
    <h3>Anika Misra</h3><p>Graph theory and graph colorings</p>
  </article>
  <article class="mentoring-item">
    <p class="item-meta">Fall 2023</p>
    <h3>Akash Kote</h3><p>The probabilistic method in combinatorics</p>
  </article>
</div>
